...
public:
  ...
  Camera(const Matrix<double> &K, const Matrix<double> &R,
  ...
  void WorldToImage(const Vector<double> &pos3D, double world_scale,
                    Vector<double> &pos2D) const;
  void ProjectToGP(const Vector<double> &pos3D, double world_scale,
                   Vector<double> &pos3D_on_plane) const;

  void getRay(Vector<double> &x, Vector<double> &ray1, Vector<double> &ray2);
  double bbToDetection(const Vector<double> &bbox, Vector<double> &pos3D,
