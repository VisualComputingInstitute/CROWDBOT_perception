...
class PolarDROW(nn.Module):
    def __init__(self, num_scans, dropout=0.5, sequential_inference=False, *args, **kwargs):
        ...
        self.sequential_inference = sequential_inference
    ...
    def forward(self, x):
        ...
        if not self.training and self.sequential_inference and n_batch == 1 and n_scan == 1:
