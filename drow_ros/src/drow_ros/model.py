...
class DROWNet3LF2p(nn.Module):
  ...
  def reset_parameters(self):
    init(self.conv1a, lambda t: nn.init.kaiming_normal_(t, a=0.1), 0)
    init(self.conv1b, lambda t: nn.init.kaiming_normal_(t, a=0.1), 0)
    init(self.conv1c, lambda t: nn.init.kaiming_normal_(t, a=0.1), 0)
    init(self.conv2a, lambda t: nn.init.kaiming_normal_(t, a=0.1), 0)
    init(self.conv2b, lambda t: nn.init.kaiming_normal_(t, a=0.1), 0)
    init(self.conv2c, lambda t: nn.init.kaiming_normal_(t, a=0.1), 0)
    init(self.conv3a, lambda t: nn.init.kaiming_normal_(t, a=0.1), 0)
    init(self.conv3b, lambda t: nn.init.kaiming_normal_(t, a=0.1), 0)
    init(self.conv3c, lambda t: nn.init.kaiming_normal_(t, a=0.1), 0)
    init(self.conv4a, lambda t: nn.init.kaiming_normal_(t, a=0.1), 0)
    init(self.conv4b, lambda t: nn.init.kaiming_normal_(t, a=0.1), 0)
    init(self.conv4p, lambda t: nn.init.constant_(t, 0), 0)
    init(self.conv4v, lambda t: nn.init.constant_(t, 0), 0)
