...
base_config = {
    ...
    "validation": {
        "sampler": {
            "type": "sequential",
            "batch_size": 32,
            "dataset": mpii_val_dataset
        }
    },
}

experiment = 'semi_pose_reid'
...
SLURM_SETTINGS = f"""#SBATCH --partition=lopri
        ...
        for model_name, model_config in model_configs.items():
            for weight_name, weighting in weightings.items():
                for scheduler_name, scheduler in schedulers.items():
                    ...
                    config["training"]["dataloader"]["sampler"]["weights"] = weighting
