"""
This code stems from https://github.com/kuangliu/pytorch-fpn/blob/master/fpn.py
Copied on: 30.01.2019
"""
...
def FPN50(pretrained=False):
    """Constructs a ResNet-FPN-50 model.
    ...
    if pretrained:
        ...
        filtered_weights = {k: v for k, v in weights.items() if not k.startswith("fc")}
        model.load_state_dict(filtered_weights, strict=False)
    return model


def FPN101(pretrained=False):
    """Constructs a ResNet-FPN-101 model.
...
def FPN152(pretrained=False):
    """Constructs a ResNet-FPN-152 model.
