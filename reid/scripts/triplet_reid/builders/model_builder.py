...
import torch
from triplet_reid.logger import get_logger
from triplet_reid.models import load_model_class, BaseModel
from triplet_reid.utils import format_dict_keys
logger = get_logger()
...
def get_model_dic_from_file(file):
...
def build(cfg):
    ...
    if 'weights' in cfg:
        ...
        file_model_dict = get_model_dic_from_file(init_from_file)
